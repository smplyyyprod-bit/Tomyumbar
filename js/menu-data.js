...
const MENU_DATA = [
  ...
  },
  {
    ...
    // Real dishes from menu.tomyumbar.com (added from client-supplied
    // screenshots — see note at the top of this file). More to follow.
    items: [
      {
        name: { ru: "Гёдза с творогом и цукатами (детская)", en: "Cottage Cheese & Candied Fruit Gyoza (Kids)" },
        description: { ru: "Лёгкие гёдза с творогом и цукатами, карамельный сироп.", en: "Light cottage cheese and candied fruit gyoza with caramel syrup." },
        fullDescription: {
          ru: "Наша облегчённая версия знаменитых японских пельменей для самых важных гостей. Блюдо подаётся с карамельным сиропом.",
          en: "Our lighter take on the famous Japanese dumplings, for our most important guests. Served with caramel syrup.",
        },
        ingredients: { ru: "Тесто гёдза, творог, цукаты, карамельный сироп", en: "Gyoza dough, cottage cheese, candied fruit, caramel syrup" },
        allergens: { ru: "Глютен, молочные продукты, яйцо", en: "Gluten, dairy, egg" },
        price: "29,000",
        weight: { ru: "60/30 г", en: "60/30 g" },
        tags: [],
        nutrition: { calories: 367, protein: 7, fat: 23, carbs: 30 },
        image: "assets/images/dish-kids-gyoza.jpg",
      },
      {
        name: { ru: "Bento-Box с курицей / удон с сыром", en: "Chicken Bento Box / Udon with Cheese" },
        description: { ru: "Детский ланчбокс с курицей темпура и удоном с сыром.", en: "Kids' lunchbox with chicken tempura and cheesy udon." },
        fullDescription: {
          ru: "Детский ланчбокс с курицей темпура и удоном с сыром. К ним подаются свежие овощи: дольки томатов, ломтики огурца и моркови.",
          en: "A kids' lunchbox with chicken tempura and udon noodles with cheese, served with fresh vegetables — tomato wedges, cucumber and carrot sticks.",
        },
        ingredients: { ru: "Курица темпура, лапша удон, сыр, томаты, огурец, морковь", en: "Chicken tempura, udon noodles, cheese, tomato, cucumber, carrot" },
        allergens: { ru: "Глютен, молочные продукты, яйцо", en: "Gluten, dairy, egg" },
        price: "54,000",
        weight: { ru: "145/130 г", en: "145/130 g" },
        tags: [],
        nutrition: { calories: 455, protein: 21, fat: 3, carbs: 50 },
        image: "assets/images/dish-kids-bento-chicken.jpg",
      },
      {
        name: { ru: "Bento-Box с креветками / удон с сыром", en: "Shrimp Bento Box / Udon with Cheese" },
        description: { ru: "Детский ланчбокс с хрустящими креветками и удоном с сыром.", en: "Kids' lunchbox with crispy shrimp and cheesy udon." },
        fullDescription: {
          ru: "Детский ланчбокс с хрустящими креветками и удоном с сыром. К ним подаются свежие овощи: дольки томатов, ломтики огурца и моркови.",
          en: "A kids' lunchbox with crispy shrimp and udon noodles with cheese, served with fresh vegetables — tomato wedges, cucumber and carrot sticks.",
        },
        ingredients: { ru: "Креветки темпура, лапша удон, сыр, томаты, огурец, морковь", en: "Tempura shrimp, udon noodles, cheese, tomato, cucumber, carrot" },
        allergens: { ru: "Морепродукты, глютен, молочные продукты, яйцо", en: "Shellfish, gluten, dairy, egg" },
        price: "89,000",
        weight: { ru: "155/130 г", en: "155/130 g" },
        tags: [],
        nutrition: { calories: 357, protein: 14, fat: 8, carbs: 55 },
        image: "assets/images/dish-kids-bento-shrimp.jpg",
      },
      {
        name: { ru: "Курица Самуи темпура (детская)", en: "Samui Chicken Tempura (Kids)" },
        description: { ru: "Сочные кусочки курицы, обжаренные во фритюре.", en: "Juicy chicken bites, deep-fried." },
        fullDescription: {
          ru: "Сочные кусочки курицы, обжаренные во фритюре.",
          en: "Juicy chicken bites, deep-fried.",
        },
        ingredients: { ru: "Куриное филе, темпурное тесто", en: "Chicken breast, tempura batter" },
        allergens: { ru: "Глютен, яйцо", en: "Gluten, egg" },
        price: "49,000",
        weight: { ru: "150 г", en: "150 g" },
        tags: [],
        nutrition: { calories: 232, protein: 26, fat: 2, carbs: 26 },
        image: "assets/images/dish-kids-chicken-tempura.jpg",
      },
      {
        name: { ru: "Нежность Фудзиямы", en: "Fuji Tenderness" },
        description: { ru: "Сырно-сливочный десерт на песочной основе, физалис.", en: "Cheese-cream dessert on a shortbread base, finished with physalis." },
        fullDescription: {
          ru: "Авторский сырно-сливочный десерт. Нежнейшая основа из творожного сыра, сливок и сахарной пудры на корже из тающего во рту песочного теста. Украшен физалисом.",
          en: "A signature cheese-cream dessert — a delicate blend of cream cheese, cream and powdered sugar over a melt-in-the-mouth shortbread base, finished with physalis.",
        },
        ingredients: { ru: "Творожный сыр, сливки, сахарная пудра, песочное тесто, физалис", en: "Cream cheese, cream, powdered sugar, shortbread crust, physalis" },
        allergens: { ru: "Молочные продукты, глютен, яйцо", en: "Dairy, gluten, egg" },
        price: "50,000",
        weight: { ru: "130 г", en: "130 g" },
        tags: [],
        nutrition: { calories: 503, protein: 5, fat: 35, carbs: 39 },
        image: "assets/images/dish-kids-cheesecake.jpg",
      },
      {
        name: { ru: "Банан в темпуре", en: "Tempura Banana" },
        description: { ru: "Кусочки банана в темпуре с карамелью или шоколадом.", en: "Tempura-fried banana with caramel or chocolate." },
        fullDescription: {
          ru: "Кусочки спелого банана, обжаренные в темпуре. Топпинг на выбор: карамель / шоколад.",
          en: "Pieces of ripe banana, deep-fried in tempura batter. Choice of topping: caramel or chocolate.",
        },
        ingredients: { ru: "Банан, темпурное тесто, топпинг (карамель или шоколад)", en: "Banana, tempura batter, topping (caramel or chocolate)" },
        allergens: { ru: "Глютен, молочные продукты", en: "Gluten, dairy" },
        price: "45,000",
        weight: { ru: "120/20 г", en: "120/20 g" },
        tags: [],
        nutrition: { calories: 417, protein: 5, fat: 20, carbs: 52 },
        image: "assets/images/dish-kids-banana-tempura.jpg",
      },
      {
        name: { ru: "Гёдза тайский штрудель (детская)", en: "Thai Strudel Gyoza (Kids)" },
        description: { ru: "Сладкая гёдза с тайской начинкой, карамельный сироп.", en: "Sweet gyoza with a Thai-inspired filling, caramel syrup." },
        fullDescription: {
          ru: "Наша облегчённая версия знаменитых японских пельменей для самых важных гостей. Блюдо подаётся с карамельным сиропом.",
          en: "Our lighter take on the famous Japanese dumplings, for our most important guests. Served with caramel syrup.",
        },
        ingredients: { ru: "Тесто гёдза, тайская начинка, карамельный сироп", en: "Gyoza dough, Thai-style filling, caramel syrup" },
        allergens: { ru: "Глютен, молочные продукты", en: "Gluten, dairy" },
        price: "29,000",
        weight: { ru: "60/30 г", en: "60/30 g" },
        tags: [],
        nutrition: { calories: 410, protein: 2, fat: 28, carbs: 35 },
        image: "assets/images/dish-kids-gyoza-sweet.jpg",
      },
      {
        name: { ru: "Гёдза с яблоком и корицей (детская)", en: "Apple & Cinnamon Gyoza (Kids)" },
        description: { ru: "Гёдза с начинкой из яблока и корицы, карамельный сироп.", en: "Gyoza filled with apple and cinnamon, caramel syrup." },
        fullDescription: {
          ru: "Наша облегчённая версия знаменитых японских пельменей для самых важных гостей. Блюдо подаётся с карамельным сиропом.",
          en: "Our lighter take on the famous Japanese dumplings, for our most important guests. Served with caramel syrup.",
        },
        ingredients: { ru: "Тесто гёдза, яблоко, корица, карамельный сироп", en: "Gyoza dough, apple, cinnamon, caramel syrup" },
        allergens: { ru: "Глютен", en: "Gluten" },
        price: "29,000",
        weight: { ru: "60/30 г", en: "60/30 g" },
        tags: [],
        nutrition: { calories: 167, protein: 2, fat: 1, carbs: 35 },
        image: "assets/images/dish-kids-gyoza-sweet.jpg",
      },
      {
        name: { ru: "Креветочные чипсы премиум", en: "Premium Shrimp Chips" },
        description: { ru: "Лёгкие хрустящие чипсы из креветочного экстракта.", en: "Light, airy, crispy shrimp-extract chips." },
        fullDescription: {
          ru: "Лёгкие, воздушные, хрустящие чипсы из креветочного экстракта.",
          en: "Light, airy, crispy chips made from shrimp extract.",
        },
        ingredients: { ru: "Креветочный экстракт, крахмал", en: "Shrimp extract, starch" },
        allergens: { ru: "Морепродукты", en: "Shellfish" },
        price: "28,000",
        weight: { ru: "25 г", en: "25 g" },
        tags: [],
        nutrition: { calories: 114, protein: 0, fat: 10, carbs: 3 },
        image: "assets/images/dish-kids-shrimp-chips.jpg",
      },
      {
        name: { ru: "Филадельфия классик (детская)", en: "Philadelphia Classic (Kids)" },
        description: { ru: "Ролл с лососем и сливочным сыром, без васаби и имбиря.", en: "Salmon and cream cheese roll, served without wasabi or ginger." },
        fullDescription: {
          ru: "Рис, нори, сливочный сыр, свежий лосось равномерно покрывает ролл с трёх сторон. Обращаем внимание, что детские роллы подаются без васаби и имбиря.",
          en: "Rice, nori, cream cheese, and fresh salmon evenly wrapping the roll on three sides. Please note kids' rolls are served without wasabi or ginger.",
        },
        ingredients: { ru: "Рис, нори, сливочный сыр, лосось", en: "Rice, nori, cream cheese, salmon" },
        allergens: { ru: "Рыба, молочные продукты, глютен", en: "Fish, dairy, gluten" },
        price: "105,000",
        weight: { ru: "200 г", en: "200 g" },
        tags: [],
        nutrition: { calories: 422, protein: 20, fat: 15, carbs: 51 },
        image: "assets/images/dish-kids-philadelphia.jpg",
      },
    ],
  },
  {
