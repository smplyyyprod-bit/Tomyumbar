...
const MENU_DATA = [
  {
    ...
    items: [
      {
        name: { ru: "Сет от шефа «Огонь Азии»", en: "Chef's “Fire of Asia” Set" },
        description: { ru: "Дегустационный сет из фирменных блюд шефа.", en: "Tasting set of the chef's signature dishes." },
        fullDescription: {
          ru: "Кураторская подборка самых ярких блюд TomYumBar на двоих — от сашими до вока — собранная шефом, чтобы показать весь диапазон кухни в одном сете.",
          en: "A curated selection of TomYumBar's boldest dishes for two — from sashimi to wok — assembled by the chef to show the full range of the kitchen in one set.",
        },
        ingredients: { ru: "Лосось, тунец, говядина вагю, овощи, рис, соусы шефа", en: "Salmon, tuna, wagyu beef, vegetables, rice, chef's sauces" },
      ...
      {
        name: { ru: "Утка по-пекински от шефа", en: "Chef's Peking Duck" },
        description: { ru: "Утка, томлёная 12 часов, блинчики, соус хойсин.", en: "12-hour slow-roasted duck, pancakes, hoisin sauce." },
        fullDescription: {
          ru: "Классика, доведённая до совершенства: утка томится 12 часов до хрустящей корочки и подаётся с тонкими блинчиками, свежим огурцом, зелёным луком и соусом хойсин — собери свой рулет за столом.",
          en: "A classic taken to its limit: duck slow-roasted for 12 hours until the skin turns crisp, served with thin pancakes, cucumber, scallion and hoisin sauce — build your own wraps at the table.",
        },
        ingredients: { ru: "Утка, мучные блинчики, огурец, зелёный лук, соус хойсин", en: "Duck, flour pancakes, cucumber, scallion, hoisin sauce" },
        allergens: { ru: "Глютен, соя", en: "Gluten, soy" },
        price: "295,000",
        weight: { ru: "450 г", en: "450 g" },
        tags: [],
      },
    ],
  },
